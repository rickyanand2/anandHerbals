...
<html class="no-js" lang="en">
	...
	<body class="bodyAttr">
		...
		<div class="row">
			<div class="large-12 large-centered columns">
				...
				<ul data-orbit >
					...
					<li>
						<img class="orbiImagetWidth" src="../../webroot/img/biogasbanner.png" alt="Bio Gas Plant"/>

					</li>
					<li>
						<img class="orbiImagetWidth" src="../../webroot/img/windenergy.jpg" alt="Wind Energy"/>
					</li>

					<li>
						<img class="orbiImagetWidth" src="../../webroot/img/solarPan.png" alt="Solar Panels"/>
					</li>
				</ul>
			</div>
			<!-- End of Orbit -->
		...
		<div class="row">
			<div class="large-12 columns">
				...
				<div class="large-4 columns hide-for-small" >
						...
						<img class="biggerImage" src="../../webroot/img/solar1.jpg" alt="birdEye" />
						<br>
				</div>
		...
		<script>
			document.write('<script src=' + ('__proto__' in {} ? '../../webroot/js/vendor/zepto' : '../../webroot/js/vendor/jquery') + '.js><\/script>')
		</script>
